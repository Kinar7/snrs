...
ent-WeaponPistolG22AutoBorg = Glock-22B Auto
    .desc = Designed by Nanotrasen’s Small Arms Division for direct use in borg units. The Glock-22B Auto is an automatic sidearm adapted for synthetic systems. It offers stable operation, reduced maintenance, and reliable performance during continuous firing.
